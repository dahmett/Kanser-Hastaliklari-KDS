...
if ($_POST) {
    ...
    $tedavi_sayi = $conn->query("SELECT * FROM muayene WHERE ted_id='$m_ted_id'");

    $sayılar = array();
    $sayılar[] = 0; $sayılar[] = 0; $sayılar[] = 0;$sayılar[] = 0;$sayılar[] = 0; $sayılar[] = 0; $sayılar[] = 0;$sayılar[] = 0;$sayılar[] = 0; $sayılar[] = 0; $sayılar[] = 0;$sayılar[] = 0;
    $count = 0;
    $maxCount = 3;
    while ($ege = $tedavi_sayi->fetch_assoc()) 
    { 
      ...
      if ($sayılar[$ay] >= $maxCount)
      {
        echo "Senenin ";
          echo $ay+1;
          echo ". ayı riskli, İlaç Sayılarını Kontrol Et!"; 
          echo "\n";
      }
    }
...
window.onload = function () {
 ...
 var chart = new CanvasJS.Chart("chartContainer", {
   ...
   title: {
     text: "Tedavi Türlerinin Aylara Göre Dağılımı"
   },
   axisY: {
     title: "Tedavi Sayısı"
   },
