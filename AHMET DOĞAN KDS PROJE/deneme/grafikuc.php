...
$evre_turu = $conn->query("SELECT * FROM muayene");
...
<div id="main">
  ...
  <p class="redtext">Kanser Hastalıkları Karar Destek Sistemi Proje Ödevi</p>
...
if ($_POST) {
    ...
    $evre_sayi = $conn->query("SELECT * FROM muayene WHERE evre_id='$m_evre_id'");

    $sayılar = array();
    $sayılar[] = 0; $sayılar[] = 0; $sayılar[] = 0;$sayılar[] = 0;$sayılar[] = 0; $sayılar[] = 0; $sayılar[] = 0;$sayılar[] = 0;$sayılar[] = 0; $sayılar[] = 0; $sayılar[] = 0;$sayılar[] = 0;
    $count = 0;
    $maxCount = 3;
    while ($ege = $evre_sayi->fetch_assoc()) 
    { 
...
window.onload = function () {
 ...
 var chart = new CanvasJS.Chart("chartContainer", {
   ...
   title: {
     text: "Evrelerin Aylara Göre Dağılımı"
   },
   axisY: {
     title: "Evre Sayısı"
   },
